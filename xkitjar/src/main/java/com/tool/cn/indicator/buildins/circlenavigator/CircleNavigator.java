package com.tool.cn.indicator.buildins.circlenavigator;
...
public class CircleNavigator extends View implements IPagerNavigator {
    ...
    private void init(Context context) {
        ...
        mRadius = XKit.dp2px(context, 3);
        mCircleSpacing = XKit.dp2px(context, 8);
        mStrokeWidth = XKit.dp2px(context, 1);
    }
