...
/**
 * author 张海洋
 * create on   2019/11/20 14:21
 * description  圆形进度条ProgressBar  可以改变颜色和宽度
 */
...
public class CricleProgressView extends View {
    ...
    public CricleProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColors = a.getColor(R.styleable.CircularProgress_borderColor, Color.parseColor("#ffffff"));
        a.recycle();
...
//                    mCurrentSweepAngle / (360 - MIN_SWEEP_ANGLE * 2)));       //根据旋转角度渐变
    ...
    private Property<CricleProgressView, Float> mAngleProperty = new Property<CricleProgressView, Float>(Float.class, "angle") {
        @Override
        public Float get(CricleProgressView object) {
            return object.getCurrentGlobalAngle();
        }

        @Override
        public void set(CricleProgressView object, Float value) {
            object.setCurrentGlobalAngle(value);
        }
    };

    private Property<CricleProgressView, Float> mSweepProperty = new Property<CricleProgressView, Float>(Float.class, "arc") {
        @Override
        public Float get(CricleProgressView object) {
